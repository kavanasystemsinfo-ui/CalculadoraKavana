        ...
        block.innerHTML = `
            ...
            <div class="model-subgrid">
                <div class="subfield">
                    ...
                    <input type="number" class="model-package" placeholder="Pz/Paq" value="${model.piecesPerPackage || ''}" min="1">
                </div>
                <div class="subfield">
                    <label style="font-size:10px;color:var(--text-dim);display:block;margin-bottom:2px;">Pz/Fila</label>
                    <input type="number" class="model-row" placeholder="Pz/Fila" value="${model.piecesPerRow || ''}" min="1">
                </div>
            </div>
    ...
    handleSubmit(e) {
        ...
        const models = Array.from(modelBlocks).map(block => {
            ...
            return {
                ...
                piecesPerPallet: parseInt(block.querySelector('.model-pallet').value, 10) || null,
                piecesPerPackage: parseInt(block.querySelector('.model-package').value, 10) || null,
                piecesPerRow: parseInt(block.querySelector('.model-row').value, 10) || null,
                measures: measures
            };
